    ...
    <div>
        <div class="panel admin-panel">
            ...
            <div class="padding border-bottom">
                <a class="button border-yellow" href="#/manager/teaAdd">
            ...
            <el-table ref="multipleTable" height="420"
                ...
                <el-table-column prop="user" label="教师名称">
                </el-table-column>
                ...
                <el-table-column label="操作">
                    <template slot-scope="scope">
                        <router-link :to="{name:'teaUpdate',query:{id:scope.row.id}}" class="update">修改</router-link>
                    </template>
                </el-table-column>
            </el-table>
...
//                });
                ...
                this.$http.post('/home/deleteStu.php',{table:'teacher',ids:this.ids}).then(res=>{
                    if (res.body == 'ok'){
        ...
        mounted(){
            this.$http.post('/home/tableQuery.php',{table:'teacher'}).then(res=>{
