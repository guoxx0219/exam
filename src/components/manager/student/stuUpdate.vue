...
<script>
    export default {
        ...
        methods:{
            onSubmit(){
                this.$http.post('/home/managerUpdate.php',{table:'student',id:this.id,form:this.form}).then(res=>{
                    if (res.body == 'ok'){
        ...
        mounted(){
            ...
            this.$http.post('/home/managerQuery.php',{table:'student',id:this.id}).then(res=>{
                this.form = res.body;
            })
